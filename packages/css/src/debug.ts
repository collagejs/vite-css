...
const defaultLogFileName = 'cjcss.md';
let stream: WriteStream | undefined;

/**
 * Opens the @collagejs/vite-css log file for writing.  If the file doesn't exist then it gets created; if the file 
...
/**
 * Closes the @collagejs/vite-css log file.
 */
